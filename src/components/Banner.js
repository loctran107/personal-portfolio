            ...
            <Container>
                <Row className="align-items-center">
                    <Col xs={12} md={6} xl={7}>
                        ...
                        <p> I am a Software Engineer passionate about designing and optimizing cutting-edge technology. 
                            With a strong foundation in hardware-software integration, I am eager to learn, innovate, and
                            contribute to impactful projects. My goal is to join one of the leading tech companies such as NVIDIA, Google,
